...
export default function FixturePage() {
  ...
  // NUEVA FUNCIÓN: Abrir modal y buscar predicciones del partido
                      ...
                      <div className="grid grid-cols-3 items-center gap-2">
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 w-full">
                          {partido.estado === 'pendiente' ? (
                            ...
                            // MODIFICADO: Cuando el partido ya empezó/terminó, agregamos el botón de espiar
                            <div className="flex flex-col items-center gap-2.5 w-full">
                              ...
                              <button 
                                ...
                                className="text-[11px] uppercase tracking-wider bg-gray-800 hover:bg-gray-700 text-gray-300 px-3 py-1.5 rounded w-full font-bold transition border border-gray-700"
                              >
                                👀 Ver Pronósticos
                              </button>
                            </div>
